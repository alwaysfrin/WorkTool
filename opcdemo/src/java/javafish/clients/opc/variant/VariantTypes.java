/* ===================================================================
   2006 LGPL: JEasyOpc project (javafish.clients.opc) 
 
   Modify for OPC communication. Transfer Variant between native and
   Java CODE. The code is overtaken from Apache Software Foundation
   (Jacarta project).
   ====================================================================
...
package java.javafish.clients.opc.variant;
 ...
 * @version $Id: Variant.java,v 1.10 2004/04/09 13:05:16 glens Exp $
 * @since 2002-02-09
 */
public class VariantTypes {
  ...
  /**
   * <p>
   * [V][T][P][S] currency. <span style="background-color: #ffff00">
  ...
  /**
   * <p>
   * [V][T][P][S] date. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
   ...
   *  <span style="background-color: #ffff00">How long is this?
  ...
  /**
   * <p>
   * [V][T][P][S] IDispatch *. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [V][T][S] SCODE. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [V][T][P][S] VARIANT *. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [V][T][S] IUnknown *. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [T] Standard return type. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [T] pointer type. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [T] C style array. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [T] user defined type. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
 ...
 /**
   * <p>
   * [P] FILETIME. The FILETIME structure holds a date and time associated with
   * a file. The structure identifies a 64-bit integer
   * specifying the number of 100-nanosecond intervals which have passed
   * since January 1, 1601. This 64-bit value is split into the
   * two dwords stored in the structure.
   * </p>
   */
 ...
 /**
  * <p>
  * [P] simple counted array. <span style="background-color: #ffff00">
  * How long is this? How is it to be interpreted?</span>
  * </p>
  */
  ...
  /**
   * <p>
   * [V] SAFEARRAY*. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
  ...
  /**
   * <p>
   * [V] void* for local use. <span style="background-color: #ffff00">
   * How long is this? How is it to be interpreted?</span>
   * </p>
   */
 ...
 /**
   * <p>
   * Maps the numbers denoting the variant types to
   * their corresponding variant type names.
   * </p>
   */
  ...
  static {
    ...
    Map<Long, Comparable> tm1 = new HashMap<Long, Comparable>();
    ...
    Map<Long, Comparable> tm2 = new HashMap<Long, Comparable>(tm1.size(), 1.0F);
    tm2.putAll(tm1);
    ...
    tm2 = new HashMap<Long, Comparable>(tm1.size(), 1.0F);
    tm2.putAll(tm1);
 ...
 /**
  ...
  public static String getVariantName(final long variantType) {
    String name = null;
    name = (String)numberToName.get(new Long(variantType & VT_TYPEMASK));
    // convert list of variants
    if ((variantType & VT_ARRAY) != 0) {
      name = "VT_ARRAY(" + name + ")";      
    } else if ((variantType & VT_BYREF) != 0) {
      name = "VT_BYREF(" + name + ")"; 
    }
  ...
  * variable, i.e. the length of a string, -1 is returned. If class does not
